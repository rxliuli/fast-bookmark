...
const ProjectName = 'Fast Bookmark'
...
await $`xcrun safari-web-extension-converter --bundle-identifier com.rxliuli.fast-bookmark --force --project-location .output .output/safari-mv3`
